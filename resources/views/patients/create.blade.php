    ...
    <div class="p-4">
        ...
        <form method="POST" action="{{ route('patients.store') }}">
            ...
            <div class="mt-4">
                ...
                <button class="py-2 px-4 bg-blue-600 text-white rounded">Kembali</button>
            </div>
        </form>
    </div>
    <!-- Card Section -->
    <div
        class="max-w-full mx-auto bg-white border border-gray-200 border-t-4 border-t-blue-600 shadow-2xs rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:border-t-blue-500 dark:shadow-neutral-700/70">
        <!-- Card -->
        <div class="bg-white rounded-xl shadow-xs p-4 dark:bg-neutral-800">
            <div class="mb-8">
            ...
            <form method="POST" action="{{ route('patients.store') }}">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <!-- Grid -->
                    <div class="w-full grid sm:grid-cols-12 gap-2 sm:gap-4">
                        {{-- Foto Profile --}}
                    ...
                    <!-- End Grid -->
                    <div
                        class="hidden border-t md:block md:border-t-0 md:border-s border-gray-200 dark:border-neutral-700">
                    </div>
                    <!-- Grid -->
                    <div class="w-full grid sm:grid-cols-12 gap-2 sm:gap-4">
                        <div class="sm:col-span-3">
