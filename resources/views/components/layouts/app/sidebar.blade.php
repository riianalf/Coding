...
<body class="hs-overlay-body-open hs-overlay-body-open:overflow-hidden bg-gray-50 dark:bg-neutral-900">
   <!-- ========== HEADER ========== -->
   <header
      class="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-48 w-full bg-white border-b border-gray-200 text-sm h-14 dark:bg-neutral-800 dark:border-neutral-700 lg:hs-overlay-layout-open:ps-64 transition-all duration-300">
   ...
   <!-- End Sidebar -->
   <!-- Content -->
   <div class="lg:hs-overlay-layout-open:ms-64 transition-all duration-300">
