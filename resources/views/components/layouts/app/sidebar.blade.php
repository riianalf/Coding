...
<body class="hs-overlay-body-open hs-overlay-body-open:overflow-hidden bg-white dark:bg-zinc-800">
    <!-- ========== HEADER ========== -->
    <header
        class="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-48 w-full text-sm h-14 bg-zinc-50 dark:bg-zinc-900 border-b border-gray-200 dark:border-neutral-700 lg:hs-overlay-layout-open:ps-64 transition-all duration-300">
        <nav class="mx-auto ps-2 pe-5 flex flex-wrap basis-full items-center justify-between">
            <!-- Navigation Toggle -->
            <div class=" p-2">
                <button type="button"
    ...
    <div id="hs-sidebar-content-push"
        class="hs-overlay [--body-scroll:true] lg:[--overlay-backdrop:false] [--is-layout-affect:true] [--opened:lg] [--auto-close:lg] hs-overlay-open:translate-x-0 lg:hs-overlay-layout-open:translate-x-0 lg:block lg:-translate-x-full lg:end-auto lg:bottom-0 w-64 -translate-x-full transition-all duration-300 transform h-full hidden fixed top-0 start-0 bottom-0 z-60 bg-zinc-50 dark:bg-zinc-900 border-e border-zinc-200 dark:border-zinc-700"
    ...
    <!-- End Sidebar -->
    <!-- Content -->
    <div class="lg:hs-overlay-layout-open:ms-64 transition-all duration-300 p-6 lg:p-8">
        {{-- <div class="h-screen top-14 p-4 overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500"> --}}
        {{ $slot }}
    </div>
    <!-- End Content -->
    <!-- ========== MAIN CONTENT ========== -->
