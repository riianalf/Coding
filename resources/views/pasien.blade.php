                  ...
                  <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                     ...
                     <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                        <thead class="bg-gray-50 dark:bg-neutral-800">
                           <tr>
                              <th class="ps-4 py-3 text-start"><input type="checkbox"
                                    class="shrink-0 border-gray-300 rounded-sm"></th>
                              <th class="ps-6 pe-6 py-3 text-start"><span
                                    class="text-xs font-semibold uppercase">Nama</span></th>
                              <th class="px-6 py-3 text-start"><span class="text-xs font-semibold uppercase">NIK</span>
                              </th>
                              <th class="px-6 py-3 text-start"><span class="text-xs font-semibold uppercase">ID
                                    BPJS</span></th>
                              <th class="px-6 py-3 text-start"><span
                                    class="text-xs font-semibold uppercase">Alamat</span></th>
                              <th class="px-6 py-3 text-start"><span class="text-xs font-semibold uppercase">Jenis
                                    Kelamin</span></th>
                              <th class="px-6 py-3 text-start"><span class="text-xs font-semibold uppercase">Tanggal
                                    Lahir / Umur</span></th>
                              <th class="px-6 py-3 text-end"><span class="text-xs font-semibold uppercase">Aksi</span>
                              </th>
                           </tr>
                        </thead>
                              ...
                              <tr>
                                 ...
                                 <td class="ps-6 pe-6 py-3">
                                    <div class="flex items-center gap-x-3">
                                       ...
                                       <div class="grow">
                                          <div class="text-sm font-semibold text-gray-800">{{ $patient->full_name }}
                                          </div>
                                 ...
                                 <td class="px-6 py-3">
                                    @if ($patient->birth_date)
                                       ...
                                       <span class="text-xs text-gray-500">{{ $patient->birth_date->age }} tahun</span>
                                    @else
                                       -
                                    @endif
                                 </td>
